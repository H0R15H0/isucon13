...
func fillLivestreamResponse(ctx context.Context, tx *sqlx.Tx, livestreamModel LivestreamModel) (Livestream, error) {
	...
	tags := []Tag{}
	if err := tx.SelectContext(ctx, &tags, "SELECT tags.id as id, tags.name as name FROM tags INNER JOIN livestream_tags ON tags.id = livestream_tags.tag_id WHERE livestream_tags.livestream_id = ?", livestreamModel.ID); err != nil {
		return Livestream{}, err
	}
